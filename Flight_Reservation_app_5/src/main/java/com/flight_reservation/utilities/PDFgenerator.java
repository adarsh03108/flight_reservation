...
public class PDFgenerator {
	    ...
	    public void generatePDF(Reservation reservation,String filePath ){
	    	...
	    	try {
	             ...
	             sendItinerary(reservation,document);
//	             addContent(document);
	             document.close();
	         } catch (Exception e) {
	             e.printStackTrace();
	    ...
	    private static void addMetaData(Document document) {
	    	...
	    	document.addSubject("Using text");
	    	document.addKeywords("Java, PDF,iText");
	    	document.addAuthor("Lars Vogel");
	    	document.addCreator("Lars Vogel");
	    }
	    
	    private PdfPTable  sendItinerary(Reservation reservation, Document document)throws DocumentException {
	    	Paragraph preface= new Paragraph();
	    	
	    	preface.add(new Paragraph("Flight Booking Details", catFont));
	    	
	    	preface.add(new Paragraph("Report generated by:"+"Flight Reservation Company"+" ", smallBold));
